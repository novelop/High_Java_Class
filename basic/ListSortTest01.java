 ...
 * 
 *  Comparable은 Collection에 추가되는 데이터 자체에 정렬기준을 넣고 싶을 때 즉, 내부 정렬기준을 구현하는 인터페이스 
 *  
 *  Comparator는 외부에 별도로 정렬 기준을 구현하고 싶을 때 즉, 외부 정렬 기준을 구현할 때 사용하는 인터페이스 이다. 
 *  
