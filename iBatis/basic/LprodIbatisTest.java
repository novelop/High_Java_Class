...
//         System.out.println("수정할 Lprod_ gu 입력 : ");
//         String gu = scan.next();
//         
...
//         lvo2.setLprod_nm(nm);
//     
//         //update형식) smc.update("namespace 값.id값", 파라미터클래스)
//         //   ==> 반환값 : 성공한 레코드 수 
...
//         String gu = scan.next();
//         
//         // delete형식) smc.delete("namespacce값.id값", 파라미터클래스)
//         // ==> 반환값 : 성공한 레코드 수 
...
//         
         ...
         //형식) 결과가 여러개일 때 형식) smc.queryForList("namespace값.id", "파라미터클래스");
...
//         }
         ...
         //  결과가 1개일 경우 smc.queryForObject("namespace값.id값", 파라미터클래스);
         //  반환값 : - 처리 결과가 여러개일 경우 ==> exception객체 반환
         ...
         }else { System.out.println("ID : " + lvo4.getLprod_id());
