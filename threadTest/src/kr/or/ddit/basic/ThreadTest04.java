 ...
 * 	여러개의 쓰레드가 협력해서 처리 할 때의 경과시간을 비교해 보자. 
 */
...
public class ThreadTest04 {
	...
	public static void main(String[] args) {
		...
		SumThread[] smths = new SumThread[] {
				...
				new SumThread(1000_000_000L,1500_000_000L),
				new SumThread(1500_000_000L,2_000_000_000L)
		};
...
class SumThread extends Thread{
	// 합계를 구할 영여그이 시작값과 종료값이 저장될 변수 선언
	private long min;
	private long max;
