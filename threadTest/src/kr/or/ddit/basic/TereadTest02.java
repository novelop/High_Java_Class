...
public class TereadTest02 {
	...
	public static void main(String[] args) {
		...
		//      그리고 Thread객체를 생성할 때 Thread의 생성자에 Runnable 인터페이스를 구현한 클래스의 인스턴스값을 넣어서 생성한  후
		//      이 Thread객체의 start()메서드를 호출해서 실행한다.
		MyRunner r1 = new MyRunner(); // 구현class의 인스턴스 생성 
		//Thread클래스를 생성할 때 생성자에 구현 class의 인스턴스를 넣어서 생성한다.
...
// 2) Runnable 인터페이스를 구현한 class를 작성 
